...
void Grafo::addNode(double x, double y,double larguraMapa, double alturaMapa){
        this->listaNodes.push_back(new Node(++(this->nroNodes),x,y,larguraMapa,alturaMapa));
}
...
// DECLARACAO Node
Node::Node(int id, double x, double y,double larguraMapa, double alturaMapa){
    this->id = id;
    this->x = x;
    this->y = y;  
